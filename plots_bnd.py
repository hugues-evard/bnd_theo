...
def main():
    ...
    ranges = {"x": (0., 1000.), "y": (1., 15000.)}#, "r": (-1., 1.)},
    ...
    # leg = create_legend(n_legentries=n_legentries, **kwargs)
# def create_legend(n_legentries, colwidth=0.20, x_high=0.9, y_high=0.88, textSize=0.05, height_per_legitem=0.07):
    ...
    # plotter.CreateLegend(n_legentries = 2)
